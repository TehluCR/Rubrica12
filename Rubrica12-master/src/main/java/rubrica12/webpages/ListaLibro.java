...
public class ListaLibro extends WebPage {
	private static final long serialVersionUID = -1935854748907274886L;

	@SpringBean
	BookService bookService;

	private static final Logger logger = LogManager.getLogger(ListaLibro.class.getName());

	private String currentNameSearchBook = null;

	private List listBook = Collections.emptyList();

	public ListaLibro(PageParameters parameters) {
